...
import com.example.mynotekeeper.NoteKeeperProviderContract.Courses;
...
public class NoteActivity extends AppCompatActivity
    ...
    public static final int LOADERS_NOTES = 0;
    public static final int LOADER_COURSES = 1;
    private final String TAG = getClass().getSimpleName();
    public static final String NOTE_ID = "com.example.mynotekeeper.NOTE_ID";
    public static final String ORIGINAL_NOTE_COURSE_ID = "com.example.mynotekeeper.ORIGINAL_NOTE_COURSE_ID";
    public static final String ORIGINAL_NOTE_TITLE = "com.example.mynotekeeper.ORIGINAL_NOTE_TITLE";
    public static final String ORIGINAL_NOTE_TEXT = "com.example.mynotekeeper.ORIGINAL_NOTE_TEXT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mIsNewNote)
            LoaderManager.getInstance(this).initLoader( LOADERS_NOTES, null, this);
    }
  ...
  //      mNote = DataManager.getInstance().getNotes().get(mNoteId);
   ...
   /*     return new CursorLoader(this){
    ...
    private void loadFinishNote(Cursor data) {
        mNoteCursor =data;
        mCourseIdPos = mNoteCursor.getColumnIndex(NoteInfoEntry.COLUMN_COURSE_ID);
        mNoteTitlePos = mNoteCursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TITLE);
        mNoteTextPos = mNoteCursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TEXT);
