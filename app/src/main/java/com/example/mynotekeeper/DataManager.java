...
public class DataManager {
   ...
   public static void loadFromDatabase(NoteKeeperOpenHelper dbHelper) {
    ...
    private static void loadNoteFromDatabase(Cursor cursor) {
       int noteIdPos = cursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TITLE);
       int noteTitlePos = cursor.getColumnIndex(NoteInfoEntry.COLUMN_NOTE_TEXT);
       ...
       while (cursor.moveToNext()) {
           ...
           String noteText = cursor.getString(noteIdPos);
